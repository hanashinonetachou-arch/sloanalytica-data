...
blue.normalizeRoundedCategoryProbabilities=true;
blue.userReason='青7BIG終了画面は犬夜叉・殺生丸・桔梗・犬夜叉&かごめの完全分布として評価します。公開値は設定2・3で丸め合計が1.001のため、Research原値を保持したまま採用時のみ厳密に正規化します。犬夜叉と2人画面は同じカウンター入力をEvidenceにも共有します。';
