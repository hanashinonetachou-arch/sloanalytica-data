...
function exposureTrials(feature,games,setting){
...
function trialsFor(feature,games,setting){
  const n=exposureTrials(feature,games,setting);
  if(n===null) throw new Error(`unresolved benchmark exposure: ${feature.researchFeatureId} @ ${games}G ${setting}`);
  return n;
}
