...
const IDS=['L_GOD_EATER_RESURRECTION','L_GODZILLA_VS_EVANGELION_JA','L_GOLDEN_KAMUY_KR','L_HEY_ELITE_SALARYMAN_KAGAMI_PA4','L_HOKUTO_MUSOU_FS','L_KAMEN_RIDER_7RIDERS_UJA','L_KARAKURI_CIRCUS_G','L_KINNIKUMAN4_SLDC','L_LOVEKYURE2_PS','L_MACROSS_FRONTIER4_BA'];
