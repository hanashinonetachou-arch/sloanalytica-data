...
export function auditV64ObservationTrialUniverse(rootArg='.') {
  ...
  return {schemaVersion:'v6.4-observation-trial-universe-audit-v1',generatedAt:new Date().toISOString(),summary,issueCounts,machines};
}
...
if(isDirect){
  ...
  const {summary,issueCounts}=report;
