...
const REVIEWED = {
  ...
  // Fire Force RF_CROSS_BONUS and Garupan RF_CZ are also resolved as rejection-reason issues:
  // they remain excluded for explicit model/information reasons rather than causal relation itself.
