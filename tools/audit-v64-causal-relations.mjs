...
const REVIEWED = {
  ...
  'L_TOARU_ACCELERATOR_RZ/RF_CZ_ACCEL': ['MUTUALLY_EXCLUSIVE_COMPOSITION','KEEP_COMPONENT_EXCLUDED_PREFER_COMPOSITION','One CZ category sharing the normal-game trial universe with total CZ; use the richer category composition instead of total plus component.'],
  'L_TOARU_ACCELERATOR_RZ/RF_CZ_LASTORDER': ['MUTUALLY_EXCLUSIVE_COMPOSITION','KEEP_COMPONENT_EXCLUDED_PREFER_COMPOSITION','One CZ category sharing the normal-game trial universe with total CZ; use the richer category composition instead of total plus component.'],
  'L_TOARU_ACCELERATOR_RZ/RF_CZ_DUAL': ['MUTUALLY_EXCLUSIVE_COMPOSITION','KEEP_COMPONENT_EXCLUDED_PREFER_COMPOSITION','One CZ category sharing the normal-game trial universe with total CZ; use the richer category composition instead of total plus component.'],
  'L_TOARU_ACCELERATOR_RZ/RF_CZ_OUTCOME': ['MUTUALLY_EXCLUSIVE_COMPOSITION','REOPEN_AS_REPLACEMENT_FOR_AGGREGATE','Complete CZ-type composition can replace aggregate CZ without double-counting and can retain type information.'],
