...
const machineId='S_FUNKY_JUGGLER_2_KT';

test('Funky Juggler 2 Observation v2 maps predecessor and self-play Features',()=>{
...
test('Funky Juggler 2 clears Observation REVIEW but preserves unresolved auxiliary surfaces as debt',()=>{
  ...
  assert.ok(m.issues.some(x=>x.type==='SOURCE_COVERAGE_UNRESOLVED'&&x.sourceSurface==='linkedService'));
});
