...
- Legacy migration: 89 interactive inputs / 82 machines
- Legacy lexical abstractions: 89 inputs / 82 machines
...
- **FAIL** LEGACY_INTERACTIVE_MIGRATION_INPUTS: expected 88, actual 89
...
- LEGACY_ABSTRACTION_NEEDS_OBSERVATION_CONTEXT: 89
