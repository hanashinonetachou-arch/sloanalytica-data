...
- **SUMUI-014**: Until a deterministic boundary mapping for 「主要」「有力」「補助」「微小」 is explicitly defined in this Manifest, Canonical UI generation MUST BLOCK rather than guess an importance label. The reference-machine rerun MUST therefore resolve this mapping before Canonical UI is accepted.
